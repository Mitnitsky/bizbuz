  ...
  <div class="max-w-7xl mx-auto w-full p-4">
    ...
    <div class="grid grid-cols-1 min-[800px]:grid-cols-3 gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5">
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.profile') }}</h3>
        ...
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.familySettings') }}</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5">
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.categories') }}</h3>
        ...
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.automation') }}</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5">
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.appearance') }}</h3>
        ...
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.display') }}</h3>
        ...
        <h3 class="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-3">{{ t('settings.layout') }}</h3>
