  ...
  <div class="max-w-2xl mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ t('categories.title') }}</h1>
      </div>
      <button
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow divide-y divide-gray-200 dark:divide-gray-700 mb-6">
      ...
      >
        ...
        <template v-if="renamingId === cat.id">
          <input
            v-model="renameHe"
            class="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-1.5 text-sm"
            dir="rtl"
          />
          <input
            v-model="renameEn"
