      ...
      <div class="space-y-2 mb-4">
        <div v-for="(cond, i) in editingRule.conditions" :key="i" class="flex flex-wrap items-center gap-2">
          ...
          <input
            v-model="cond.value"
            type="text"
            class="flex-1 min-w-[120px] rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300 px-3 py-2 text-sm"
