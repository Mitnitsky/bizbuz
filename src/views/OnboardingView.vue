  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 py-8">
    <div class="w-full max-w-2xl">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ t('auth.welcomeToBizbuz') }}</h1>
      ...
      <div class="flex flex-col md:flex-row gap-6 items-stretch">
        ...
        <div class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ t('auth.createFamily') }}</h2>
          ...
          <form @submit.prevent="handleCreateFamily" class="space-y-3">
            <input
              ...
              required
              class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition"
            />
        ...
        <!-- Join Family -->
        <div class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ t('auth.joinExistingFamily') }}</h2>
