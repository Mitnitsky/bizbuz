  ...
  >
    <div class="flex items-center justify-between mb-3">
      <div class="flex items-center gap-2">
        <span class="text-lg font-bold text-gray-900 dark:text-gray-300">{{ investment.name }}</span>
    ...
    <div class="flex justify-between">
      ...
      <div class="text-right">
        ...
        <div class="text-sm font-bold text-gray-900 dark:text-gray-300">{{ formatCurrency(investment.currentValue) }}</div>
      </div>
    </div>
  </div>
</template>
