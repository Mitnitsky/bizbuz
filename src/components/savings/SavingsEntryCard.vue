  ...
  >
    <div class="flex-1 min-w-0">
      <div class="flex items-center gap-2">
        <span class="font-medium text-gray-900 dark:text-gray-300 truncate">{{ entry.name }}</span>
    ...
    <div class="flex items-center gap-2 ml-4 shrink-0">
      <span class="font-bold text-gray-900 dark:text-gray-300">{{ formatCurrency(entry.amount) }}</span>
    </div>
  </div>
</template>
