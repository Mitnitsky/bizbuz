...
const inputClass = 'w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300 px-3 py-2'
const inputClassSm = 'w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300 px-2.5 py-1.5 text-sm'
  ...
  <Teleport to="body">
    <div v-if="open" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" @click.self="emit('close')">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg p-6 flex flex-col" style="max-height: 90vh;">
        <h3 class="text-lg font-bold text-gray-900 dark:text-gray-300 mb-4 shrink-0">{{
          isEdit
            ...
            <div v-for="(track, idx) in tracks" :key="track.id" class="mb-3 border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
              ...
              <div v-if="track.expanded" class="p-3 space-y-2.5">
                ...
                <div v-if="track.rateType === 'variable'" class="flex items-center gap-2">
                  ...
                  <input v-model="track.variableIntervalYears" type="number" min="1" class="w-16 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300 px-2 py-1.5 text-sm" />
